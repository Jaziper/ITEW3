...
<body>
    ...
    <div class="landing">
        <h1>UCOMMERCE <br><small class="text-body-secondary">Become a Seller Now</small></h1>
                    ...
                    <div class="modal-body">
                        <form id="loginForm" action="login.php" method="POST">
                            <div class="form-group">
                                ...
                                value="<?php echo isset($_COOKIE['email']) ? htmlspecialchars($_COOKIE['email'], ENT_QUOTES, 'UTF-8') : ''; ?>"required>
                            </div>
                            <div class="form-group">
                                <label for="login-password" class="col-form-label">Password:</label>
                                <input type="password" class="form-control" id="login-password" name="password" 
                                value="<?php echo isset($_COOKIE['password']) ? htmlspecialchars($_COOKIE['password '], ENT_QUOTES, 'UTF-8') : ''; ?>" required>
                            </div>
                            <div class="form-group">
